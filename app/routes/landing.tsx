            ...
            <div className="hero-section relative overflow-hidden py-12 md:py-20 mb-8 md:mb-12 px-4">
              <div className="relative z-10 text-center">
                ...
                <div className="flex flex-col md:flex-row items-center justify-center mb-8">
                  <svg
                    className="w-6 md:w-8 h-6 md:h-8 text-blue-600 mb-2 md:mb-0 md:mr-3"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
                  ...
                  {resumes?.length === 0 ? (
                    <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 md:p-8 shadow-lg border border-gray-100">
                      <div className="flex flex-col md:flex-row items-center justify-center mb-4">
                        <svg
                          className="w-12 md:w-16 h-12 md:h-16 text-orange-500 mb-3 md:mb-0 md:mr-4"
                          fill="none"
                          stroke="currentColor"
                          viewBox="0 0 24 24"
                        >
                      ...
                      <p className="text-base md:text-lg text-gray-600 leading-relaxed">
                        No resumes found. Upload your first resume to get professional AI-powered
                        feedback and start optimizing your job search journey.
                      </p>
                    </div>
                  ) : (
                    <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 md:p-8 shadow-lg border border-gray-100">
                      <div className="flex flex-col md:flex-row items-center justify-center mb-4">
                        <svg
                          className="w-12 md:w-16 h-12 md:h-16 text-green-500 mb-3 md:mb-0 md:mr-4"
                          fill="none"
                          stroke="currentColor"
                          viewBox="0 0 24 24"
                        >
                        ...
                        <h3 className="text-lg md:text-xl font-semibold text-gray-800">
                          Your Portfolio is Active
                        </h3>
                      </div>
                      <p className="text-base md:text-lg text-gray-600 leading-relaxed">
                        Review your submissions and check AI-powered feedback to continuously
                        improve your applications and increase your success rate.
                      </p>
                    </div>
                  )}
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 mt-8 md:mt-12 max-w-6xl mx-auto px-4">
                <div className="bg-white/70 backdrop-blur-sm rounded-xl p-4 md:p-6 shadow-md hover:shadow-lg transition-all duration-300 hover:scale-105">
                  ...
                  <p className="text-gray-600 text-sm">
                    Get instant feedback on your resume with advanced AI technology
                  </p>
                </div>
                ...
                <div className="bg-white/70 backdrop-blur-sm rounded-xl p-4 md:p-6 shadow-md hover:shadow-lg transition-all duration-300 hover:scale-105">
                  <div className="bg-green-100 w-12 h-12 md:w-16 md:h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                    <svg
                      className="w-6 md:w-8 h-6 md:h-8 text-green-600"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
                  ...
                  <p className="text-gray-600 text-sm">
                    Monitor your application success rates and improvements over time
                  </p>
                </div>
                ...
                <div className="bg-white/70 backdrop-blur-sm rounded-xl p-4 md:p-6 shadow-md hover:shadow-lg transition-all duration-300 hover:scale-105">
                  <div className="bg-purple-100 w-12 h-12 md:w-16 md:h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                    <svg
                      className="w-6 md:w-8 h-6 md:h-8 text-purple-600"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
                  ...
                  <p className="text-gray-600 text-sm">
                    Receive personalized suggestions to optimize your resume content
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="max-w-2xl mx-auto text-center">
                <div className="bg-white/90 backdrop-blur-sm rounded-3xl p-8 md:p-12 shadow-2xl border border-gray-100">
                  ...
                  <p className="text-base md:text-lg text-gray-600 leading-relaxed mb-6">
                    Our AI is processing your resumes and generating personalized insights. This
                    typically takes a few moments.
                  </p>
            ...
            <div className="resumes-section py-8 px-4">
              <div className="text-center mb-8 md:mb-12">
                <div className="inline-flex items-center bg-white/80 backdrop-blur-sm rounded-full px-6 md:px-8 py-3 md:py-4 shadow-lg border border-gray-100">
                  <svg
                    className="w-6 md:w-8 h-6 md:h-8 text-blue-600 mr-2 md:mr-3"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
                  ...
                  <span className="text-lg md:text-xl font-semibold text-gray-800">
                    Your Resume Portfolio ({resumes.length}{" "}
                    {resumes.length === 1 ? "Resume" : "Resumes"})
                  </span>
                </div>
              </div>

              {/* Responsive Grid - Fixed for multiple resumes */}
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 gap-4 sm:gap-6 md:gap-8 w-full max-w-[1600px] mx-auto px-4">
                {resumes.map((resume) => (
                  <div
                    key={resume.id}
                ...
                <div className="bg-gradient-to-br from-white/95 to-blue-50/95 backdrop-blur-sm rounded-3xl p-8 md:p-16 shadow-2xl border border-gray-100 relative overflow-hidden">
                  <div className="relative z-10">
                    ...
                    <p className="text-lg md:text-xl text-gray-600 leading-relaxed mb-6 md:mb-8 max-w-2xl mx-auto">
                      Start your journey to landing your dream job. Upload your resume and get
                      instant AI-powered feedback to make your application stand out from the
                      competition.
                    </p>
                    ...
                    <div className="mb-6 md:mb-8">
                      ...
                      >
                        ...
                        <svg
                          className="w-5 md:w-6 h-5 md:h-6 ml-3 md:ml-4"
                          fill="none"
                          stroke="currentColor"
                          viewBox="0 0 24 24"
                        >
      ...
      <footer className="bg-white relative overflow-hidden border-t border-gray-100">
        ...
        <div className="absolute inset-0">
          ...
          >
            ...
            <polygon
              points="680,250 720,290 680,330 640,290"
              fill="#f3e8ff"
              opacity="0.6"
            />
            <rect
            ...
            <polygon
              points="1050,80 1080,110 1050,140 1020,110"
              fill="#f0fdf4"
              opacity="0.5"
            />
          </svg>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mb-12">
            ...
            <div className="lg:col-span-2">
              ...
              <p className="text-gray-600 leading-relaxed mb-6 max-w-md">
                Empowering professionals with AI-powered resume analysis and career optimization
                tools. Turn your job applications into success stories.
              </p>
              ...
              <ul className="space-y-3">
                {[
                  ...
                  <li key={index}>
                    ...
                    >
                      <svg
                        className="w-4 h-4 mr-3 group-hover:translate-x-1 transition-transform duration-200"
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                      >
          ...
          <div className="flex flex-col lg:flex-row justify-between items-center space-y-8 lg:space-y-0 mb-8">
            ...
            <div className="flex flex-col sm:flex-row items-center space-y-3 sm:space-y-0 sm:space-x-6 text-center lg:text-left">
              <div className="flex flex-col space-y-2">
                <p className="text-gray-600 text-sm">© 2024 Resumind. All rights reserved.</p>
            ...
            <div className="flex flex-col lg:flex-row items-center space-y-6 lg:space-y-0 lg:space-x-8">
              ...
              <div className="grid grid-cols-4 gap-3">
                {[
                  {
                    href: "https://withabubakar.netlify.app/",
                    title: "Portfolio",
                    icon: "M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2-2v2m8 0V6a2 2 0 012 2v6a2 2 0 01-2 2H6a2 2 0 01-2-2V8a2 2 0 012-2V6m8 0H8",
                    bg: "bg-gradient-to-br from-blue-50 to-blue-100 hover:from-blue-100 hover:to-blue-200",
                    color: "text-blue-600",
                  },
                  {
                    href: "https://www.linkedin.com/in/mohamad-abubakar/",
                    title: "LinkedIn",
                  ...
                  {
                    href: "https://github.com/MuhammadAbuBakar69",
                    title: "GitHub",
                  ...
                  {
                    href: "mailto:md.bakar2006@gmail.com",
                    title: "Email",
                    icon: "M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z",
          ...
          <div className="bg-gradient-to-r from-blue-50 via-purple-50 to-indigo-50 rounded-2xl p-6 md:p-8 border border-blue-100">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 text-center">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-gray-600">
                  Advanced AI provides personalized recommendations
                </p>
              </div>
            </div>
