      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12">
        <div className="w-full max-w-md max-h-screen overflow-y-auto">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-8">Create your account to explore exciting career opportunities</p>
            ...
            <form onSubmit={handleEmailSignup} className="space-y-4">
              ...
              <div className="flex items-start gap-3 pt-2">
                ...
                <label htmlFor="terms" className="text-sm text-gray-600">
                  I confirm that I have read and agree to the Client Agreement, Terms & Conditions, and legal policies of Resumind
                </label>
              </div>
